...
<body>
    ...
    <h4>Check Faculty Vaccination Status</h4>
    <br><br>

    <form action="check_faculty.php" method="POST">
		...
		<div align="center">
			<input type="submit" name="All_Faculty_Search" class="button" value="All_Faculty_Search" style=" width: 300px; height: 80px;">
		</div>
    </form>
...
<?php  
	...
	if(isset($_POST['Search'])){
		...
		$ID = $_POST['ID'];
		$query="select * from faculty where NID='$ID'";
  		$result=mysqli_query($con,$query);	
	mysqli_close($con);
  		
  		}
  	if(isset($_POST['All_Faculty_Search'])){
  		$con = mysqli_connect("localhost","root","","vaccinated_information");
