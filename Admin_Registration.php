...
<body>
    ...
    <br><br><br><br>
    <h4><u>New Admin Registration</u></h4>
    <br>

    <form action="Admin_Registration.php" method="POST">

        <label for="Admin_id">Admin ID: </label>
        <input type="number" name="Admin_id" id="Admin_id" placeholder="Admin ID"  required> <br>
...
<?php 
    ...
    if(isset($_POST['Submit'])){
        ...
        if(mysqli_num_rows($sresult1) == 0){
            $query = "insert into admin_officials(NID, Name, Address, Phone_No, Date_Of_Birth) 
