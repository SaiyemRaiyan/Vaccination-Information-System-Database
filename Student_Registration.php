...
<body>
    ...
    <br><br><br><br>
    <h4><u>New Student Registration</u></h4>
    <br>

    <form action="Student_Registration.php" method="POST">

        <label for="NSU_id">Student ID: </label>
        <input type="number" name="NSU_id" id="NSU_id" placeholder="Student ID" maxlength="10" minlength="10" required> <br>
        ...
        <input type="text" name="Name" id="" placeholder="Insert Name" required><br>
       
        <label for="Address">Addess: </label>
        <input type="text" name="Address" id="Name" placeholder="Insert Address" required> <br>
...
<?php 
    ...
    if(isset($_POST['Submit'])){
        ...
        if(mysqli_num_rows($sresult1) == 0){
            $query = "insert into student( NID_Birth_Certificate, Name, Address, Phone_No, Date_Of_Birth) 
                values('$NID_Birth_Certificate','$Name','$Address','$Phone_No','$Date_Of_Birth')";
