...
<body>
    ...
    <h4>Check Admin Vaccination Status</h4>
    <br><br>
    ...
    <form action="check_admin.php" method="POST">
		...
		<div align="center">
			<input type="submit" name="All_Admin_Search" class="button" value="All_Admin_Search" style=" width: 300px; height: 80px;">
		</div>
    </form>
...
<?php  
	...
	if(isset($_POST['Search'])){
		...
		$ID = $_POST['ID'];
		$query="select * from admin_officials where NID='$ID'";
  		$result=mysqli_query($con,$query);	
	mysqli_close($con);
  		
  		}
  	if(isset($_POST['All_Admin_Search'])){
  		$con = mysqli_connect("localhost","root","","vaccinated_information");
		$query="select * from admin_officials";
  		$result=mysqli_query($con,$query);
	mysqli_close($con);
